        ...
        <div className='flex flex-col xl:flex-row justify-between h-full overflow-y-scroll hideScrollbar'>
          <div className='flex flex-col xl:w-[65%] w-full gap-4'>
            <div className='flex flex-col gap-3'>
              ...
              <section className=' grid grid-cols-3 bg-[#176DEF] text-white rounded-xl w-full'>
                <div className='p-8'>
                  <p>Assignment</p>
            ...
            <div className='flex flex-col gap-3'>
              ...
              <section className='grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-3 bg-white text-black rounded-xl w-full p-4'>
                ...
                <div className='flex flex-col gap-2'>
                  <div className='p-3 flex flex-col gap-3 border border-[#176DEF] rounded-xl'>
                    <p>Assignment 1</p>
                    <p className='flex flex-row justify-between'><span>Time_of_Post</span> <span>Date_of_Post</span></p>
                  </div>
                  <div className='p-3 flex flex-col gap-3 border border-[#176DEF] rounded-xl'>
                    <p>Assignment 1</p>
                    <p className='flex flex-row justify-between'><span>Time_of_Post</span> <span>Date_of_Post</span></p>
          ...
          <div className='mt-9 w-full xl:w-[33.5%] bg-white rounded-xl h-fit px-4 py-9 flex flex-col gap-4'>
            <section className='flex flex-col gap-3 '>
              ...
              <div className='flex flex-col w-full gap-2 overflow-y-scroll hideScrollbar'>
                <div className='p-3 flex flex-row items-center justify-between gap-3 border border-[#176DEF] rounded-xl'>
                  <div className='flex gap-4 items-center'>
                    <i className="text-[30px] fa-regular fa-user"></i>
                    <p className='flex flex-col'> <span className='font-semibold'>Sumit Kharate</span> <span>Java,Javascript</span> </p>
                  </div>
